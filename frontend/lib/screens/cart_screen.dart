      ...
      return MainLayout(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              const Icon(Icons.lock_outline, size: 60, color: AppColors.textSecondary),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(_fmt(item.unitPrice), style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold)),
                    const Spacer(),
                    _qtyCtrl(item),
                  ],
                ),

...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `invoizdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE `courier_pickups` (
  ...
  `status` enum('scheduled','picked_up','cancelled') NOT NULL DEFAULT 'scheduled',
...
CREATE TABLE `deliveries` (
  ...
  `status` enum('waiting_for_rider','assigned','picked_up','out_for_delivery','delivered','failed') NOT NULL DEFAULT 'waiting_for_rider',
...
INSERT INTO `order_items` VALUES (1,3,1,1,'Classic White T-Shirt','Color: White',2,199.00,398.00,'2026-08-14 10:43:01'),(2,3,1,1,'Classic White T-Shirt','Color: Black',1,199.00,199.00,'2026-08-14 10:43:01'),(3,4,4,1,'Moisturizing Facial Serum','Size: 30ml',1,450.00,450.00,'2026-08-14 10:56:30'),(4,4,8,1,'Bestseller Hardbound Novel',NULL,2,499.00,998.00,'2026-08-14 10:56:30'),(5,5,1,1,'Classic White T-Shirt','Size: L',1,199.00,199.00,'2026-08-14 11:10:04');
...
CREATE TABLE `payments` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) unsigned NOT NULL,
  `method` enum('cash_on_delivery','gcash','bank_transfer') NOT NULL,
...
INSERT INTO `sellers` VALUES (4,1,'Invoiz Demo Store','General Merchandise',NULL,NULL,'approved','active','2026-08-15 07:47:22','2026-08-15 07:47:22'),(5,3,'akjshd','Home & Living','seller-ids/RsPZtj93KeF8Htkrusdc5dmGbpk4Sho3ZmnDogDi.png','seller-permits/okYnQhd7o8n8pOQZYrWZLMrLy7wnnwDskIMbUjft.png','approved','active','2026-08-15 08:37:31','2026-08-15 16:39:44'),(6,5,'TechNest Gadgets','Electronics & Gadgets',NULL,NULL,'approved','active','2026-08-15 10:13:35','2026-08-15 10:13:35'),(7,6,'FreshMart PH','Groceries & Home Essentials',NULL,NULL,'approved','active','2026-08-15 10:13:35','2026-08-15 10:13:35');
...
CREATE TABLE `users` (
  ...
  `id_image` varchar(255) DEFAULT NULL,
  `approval_status` enum('pending','approved','rejected') NOT NULL DEFAULT 'pending',
  `role` enum('admin','seller','buyer','rider') NOT NULL DEFAULT 'buyer',
...
-- Dump completed on 2026-08-19 14:33:32
